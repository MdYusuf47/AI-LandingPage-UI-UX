    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl text-center mt-5 tracking-tight max-w-sm mx-auto">
          Out revolutionary AI SEO tools have transformed our client strategies
        </p>
          ...
          <div className="flex gap-5">
            {testimonials.map((testimonial) => (
              <div
                ...
                className="border-white/15 border p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(140,69,255,0.3),black)] max-w-xs md:max-w-md flex-none"
              >
